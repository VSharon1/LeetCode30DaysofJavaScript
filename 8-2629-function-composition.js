const compose = (functions) => {
  ...
  // As f is a function and not a value, it can be called with the accumulated
  // value.
  const fn = (acc, f) => f(acc);

  // Return a single function that represents the composition of all the
  // functions in the functions array.
  return (x) => {
    // reduce() method can be used to specify how to reduce/aggregate the list
    // of functions.
